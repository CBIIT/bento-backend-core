...
public class MemgraphDataFetcher implements AutoCloseable, DataFetchingInterceptor {
    private static final Logger logger = LogManager.getLogger(MemgraphDataFetcher.class);
    ...
    private void connect() {
        String uri = config.getMemgraphUrl();
